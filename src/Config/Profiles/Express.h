#ifndef EOLO_CONFIG_PROFILE_EXPRESS_H
#define EOLO_CONFIG_PROFILE_EXPRESS_H
...
inline constexpr BoardConfig kBoard = {
    150000UL, 8000000UL, 8, false, 11, 0, 8UL, ModemPowerMode::AlwaysOn,
    27, 15, 2, 18, 23, 300, 0UL, false
};
