...
{
public:
    static constexpr uint32_t kAfmIntervalMs = 800;
    static constexpr uint32_t kAnemometerIntervalMs = 1100;
    static constexpr uint32_t kAnemometerOfflineIntervalMs = 5000;
    static constexpr uint32_t kResponseStartTimeoutMs = 300;
    static constexpr uint32_t kFrameCompletionTimeoutMs = 30;
    ...
    static constexpr uint32_t kAnemometerSlotBudgetMs = 450;
